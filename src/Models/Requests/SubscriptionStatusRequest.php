...
use Nikapps\BazaarApiPhp\Handlers\SubscriptionHandler;

class SubscriptionStatusRequest extends BazaarApiRequest {
    ...
    public function getUri() {
        ...
        $uri = $this->getApiConfig()->getSubscriptionPath();
